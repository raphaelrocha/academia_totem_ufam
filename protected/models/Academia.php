...
class Academia extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('CODIGO_CONFIG, CAPACIDADE, HORA_ABERTURA, HORA_FECHAMENTO, DURACAO_PERIODO, TIPOFUNCIONAMENTO, DATA_INICIO, DATA_FIM, SITUACAO', 'required'),
...
//			array('DATA_FIM', 'date', 'format'=>'YYYY-m-d H:m:s'),
            ...
            array('HORA_ABERTURA', 'isValidTime'),
//			array('CODIGO_CONFIG, CAPACIDADE','isValidNumber'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('CODIGO_CONFIG, CAPACIDADE, HORA_ABERTURA, HORA_FECHAMENTO, DURACAO_PERIODO, TIPOFUNCIONAMENTO, DATA_INICIO, DATA_FIM, SITUACAO', 'safe', 'on'=>'search'),
        );
    }
